...
public class MenuField extends MenuComponent
{
	...
	public MenuField(String identifier, int x, int y, int width, int height, String text, Font font, Sprite sprite_off, Sprite sprite_on)
	{
	...
	public void update(float dt)
	{
		...
		{
			m_selected = true;
		} else if (!m_mouseover && InputListener.getMouseButtons()[1])
		{
			m_selected = false;
		}
	}
